		...
		<div class="col-lg-8">
			...
			<form method="POST" enctype="multipart/form-data">
				...
				<div class="form-group">
					<label>ID FILM</label>
					<input type="text" name="id_film" class="form-control" required>
				</div>

				<div class="form-group">
					<label>NAMA FILM</label>
					<input type="text" name="nama_film" class="form-control" required>
				</div>
...
<?php	
	...
	$pindah = move_uploaded_file($sumber, 'foto/'.$nama_file);
        ...
        $sql_simpan = "INSERT INTO tb_film (`id_film`, `nama_film`, `sinopsis`, `foto`) VALUES (
			'".$_POST['id_film']."',
			'".$_POST['nama_film']."',
			'".$_POST['sinopsis']."',
			'".$nama_file."')";
